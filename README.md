...
## The Tech Stack:
    ...
    Database Management: MySQL (Relational Schema Design: Master & Transaction tables)
...
Applying the technical rigor from my A+ Certification, I built this project with a focus on system integrity and efficient data flow.
    ...
    Extraction: Python scripts to handle API rate-limiting and data normalization.

    Storage: A normalized MySQL database designed to maintain data integrity across thousands of records.
